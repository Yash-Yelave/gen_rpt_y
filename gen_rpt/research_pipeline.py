...
from .logger import log_stage, log_success, log_warning, log_error
...
class ResearchPipeline:
    ...
    def build_report(self, topic: str, output_dir: Path) -> Dict:
        ...
        log_stage("PLAN", "Generating research plan")
        try:
            plan = self._plan_research(display_topic, raw_topic=topic)
        except Exception as exc:
            log_warning(f"Planning failed, using fallback: {exc}")
        ...
        log_stage("BRANDING", "Loading BO theme assets")
        ...
        log_stage("VISUALS", "Generating charts and insight cards")
        ...
        log_stage("ARCHIVE", "Saving outputs")
